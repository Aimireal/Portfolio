...
const Works = () => (
    <Layout title="Works">
        <Container>
            ...
            <SimpleGrid columns={[1, 1, 2]} gap={6}>
                <Section delay={0.5}>
                    <WorkGridItem id="aivision" title="AI Vision" thumbnail={placeholderImg}>
                ...
                <Section delay={0.5}>
                    <WorkGridItem id="monitoringstation" title="Monitoring Station" thumbnail={placeholderImg}>
                ...
                <Section delay={0.6}>
                    <WorkGridItem id="largemon" title="Largemon" thumbnail={placeholderImg}>
                ...
                <Section delay={0.6}>
                    <WorkGridItem id="auctionroom" title="Auction Room" thumbnail={placeholderImg}>
